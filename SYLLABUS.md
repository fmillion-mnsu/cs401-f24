...
Linux is an important operating system to be familiar with in most computing careers. [Every one of the top 500 most powerful computers in the world runs Linux](https://itsfoss.com/linux-runs-top-supercomputers/) and runs on [90% of cloud computing systems](https://www.enterpriseappstoday.com/stats/linux-statistics.html#Key_Linux_Statistics). Along with running on large servers as well as standard desktop and laptop computers, Linux also runs on everything from Android phones, smart watches, TV sets and streaming sticks, appliances, IoT devices, and embedded controllers. You may not realize it, but you have definitely interacted with a system running Linux.
